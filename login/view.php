            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                       ...
                       <label>      <input type="radio"  id="idtag"  value="2" name="tag">Desenho</label>
                          <label> <input type="radio"  id="idtag" value="3" name="tag">Arte</label>
                             <div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body"> Deseja realmente se deslogar do sistema?</p>
                ...
                <!-- <input type="submit" value="entrar" id="entrar" name="Enviar"><br> -->
                 <button type="submit" class="btn btn-info btn-lg" data-toggle="modal" data-target=""><a href="sair.php">Sair</a></button>
...
<div class="w3-content w3-container w3-padding-64" id="portfolio">
  ...
  <p class="w3-center" class="introducao"><em><b>Divulgue seu trabalho.<br> Inspire novas ideias<br>Colabore com a revista</b></em></p><br>
...
$query = "SELECT p.idpost,p.nomePost, p.descricao,u.nome,tp.nomTag FROM post AS p join usuario AS u
...
echo "<tr><th>id</th><th>Titulo</th><th>Descrição</th><th>Autor</th><th>tag</th><th>Ações</th></tr>";
while (list($id, $nomePost, $descricao, $nome,$nomTag) = $result->fetch_row()) {
    echo "<tr><td>$id</td><td>$nomePost</td><td>$descricao</td><td>$nome</td><td>$nomTag</td>";
    echo "<td>
...
?>
  ...
  <!-- <div class="w3-row-padding w3-center"> -->
  <!--   Aqui ficaria o post principal -->
    <!-- <div class="w3-col m12">
      <img src="./imagens/7.png" style="width:100%" onclick="onClick(this)" class="w3-hover-opacity" alt="The mist over the mountains">
    </div>
    </div>
    <br><br> -->

  <!-- Posts menos visualizados -->
